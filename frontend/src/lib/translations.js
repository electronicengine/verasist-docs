...
const SECTION_NAMES = {
  tr: {
    ...
    "workflows-nodes": "Düğümler",
    "workflows-tools": "Araçlar",
    planning: "Planlama",
    analytics: "Analitik",
...
const UI = {
  tr: {
    ...
    "sidebar.noHeadings": "",
    "apiRef.heading": "API Referansı",
    "apiRef.subtitle": "Tüm uç noktaları inceleyin ve doğrudan bu sayfadan deneyin.",
    "apiRef.tryIt": "Dene",
    "apiRef.send": "Gönder",
    "apiRef.sending": "Gönderiliyor...",
    "apiRef.parameters": "Parametreler",
    "apiRef.requestBody": "İstek gövdesi (JSON)",
    "apiRef.response": "Yanıt",
    "apiRef.status": "Durum",
    "apiRef.latency": "Süre",
    "apiRef.baseUrl": "Temel URL",
    "apiRef.apiKeyLabel": "X-API-Key",
    "apiRef.apiKeyPlaceholder": "vrs_api_anahtarınız",
    "apiRef.copyAsCurl": "cURL olarak kopyala",
    "apiRef.copied": "Kopyalandı",
    "apiRef.noResponseYet": "Henüz istek gönderilmedi.",
    "apiRef.required": "zorunlu",
    "apiRef.in": "konum",
    "apiRef.resetExample": "Örneğe sıfırla",
    "apiRef.endpointCount": "uç nokta",
    "apiRef.invalidJson": "İstek gövdesi geçerli JSON değil",
    "apiRef.specLoadError": "OpenAPI şeması yüklenemedi",
  },
  en: {
    ...
    "sidebar.noHeadings": "",
    "apiRef.heading": "API Reference",
    "apiRef.subtitle": "Browse every endpoint and try it directly from this page.",
    "apiRef.tryIt": "Try it",
    "apiRef.send": "Send",
    "apiRef.sending": "Sending...",
    "apiRef.parameters": "Parameters",
    "apiRef.requestBody": "Request body (JSON)",
    "apiRef.response": "Response",
    "apiRef.status": "Status",
    "apiRef.latency": "Latency",
    "apiRef.baseUrl": "Base URL",
    "apiRef.apiKeyLabel": "X-API-Key",
    "apiRef.apiKeyPlaceholder": "your vrs_ api key",
    "apiRef.copyAsCurl": "Copy as cURL",
    "apiRef.copied": "Copied",
    "apiRef.noResponseYet": "No request sent yet.",
    "apiRef.required": "required",
    "apiRef.in": "in",
    "apiRef.resetExample": "Reset to example",
    "apiRef.endpointCount": "endpoints",
    "apiRef.invalidJson": "Request body is not valid JSON",
    "apiRef.specLoadError": "Failed to load OpenAPI schema",
  },
};
