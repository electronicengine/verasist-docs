...
## Original Problem
Build a Turkish documentation site modeled after docs.verasist.ai with: JWT email/password login for admins to edit & add docs; full theme palette provided (dark + light with brand blues); WYSIWYG editor; in-doc search; both light & dark themes with toggle.
